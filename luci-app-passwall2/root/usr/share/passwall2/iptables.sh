...
add_firewall_rule() {
	...
	ipset -! create $ipset_global_whitelist nethash maxelem 1048576 timeout 86400
	ipset -! create $ipset_global_whitelist6 nethash family inet6 maxelem 1048576 timeout 86400
